                ...
                <ul class="nav navbar-nav side-menu" id="sidebarnav">
                    ...
                    <li>
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#elements">
                            <div class="pull-left"><i class="ti-palette"></i><span
                                    class="right-nav-text">{{trans('main_trans.employee-data')}}</span></div>
                            <div class="pull-right"><i class="ti-plus"></i></div>
                            <div class="clearfix"></div>
                        </a>
                        <ul id="elements" class="collapse" data-parent="#sidebarnav">
                            <li><a href="{{route('Employee.index')}}">قائمة موظفين</a></li>
                            <li><a href="button.html">154545</a></li>
                    ...
                    <li>
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#custom-page">
                            <div class="pull-left"><i class="ti-file"></i><span class="right-nav-text">{{trans('main_trans.basic_information')}}</span></div>
                            <div class="pull-right"><i class="ti-plus"></i></div>
                            <div class="clearfix"></div>
                        </a>
                        <ul id="custom-page" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{Route('Rank.index')}}">{{trans('main_trans.Rank')}}</a> </li>
                            <li> <a href="{{Route('groups.index')}}">{{trans('GroupAdministrator.GroupAdministrator')}} </a> </li>
                            <li> <a href="{{Route('Degrees.index')}}">{{trans('Degree_trans.Degrees')}}</a> </li>
                            <li> <a href="{{Route('Reviews.index')}}">التقييمات العسكرية</a> </li>
                            <li> <a href="{{Route('WorkNatures.index')}}">طبيعة العمل</a> </li>
                            <li> <a href="{{Route('empStatus.index')}}">حالة الموظف</a> </li>

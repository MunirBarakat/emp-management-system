                ...
                <div class="card-body">
                    ...
                    <div class="col-xs-12">
                        <div class="col-md-12">
                            ...
                            <div class="form-row">
                                <div class="col">
                                    <input type="hidden" value="{{$Reviews->id}}" name="id">
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="col">
                                    ...
                                    <input type="text" name="Type" value="{{ $Reviews->Type }}" class="form-control">
                                    @error('Name')
                            ...
                            <div class="form-row">
                                <div class="col">
                                    ...
                                    <input type="text" name="Notes" value="{{ $Reviews->Notes }}" class="form-control">
                                    @error('Name')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>

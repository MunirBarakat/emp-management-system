            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <div class="col-xs-12">
                        <div class="col-md-12">
                            <br>
                            <form action="{{route('empStatus.update','test')}}" method="post">
                             {{method_field('patch')}}
                             @csrf
                            <div class="form-row">
                                <div class="col">
                                    <input type="hidden" value="{{$EmpStatus->id}}" name="id">
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="col">
                                    ...
                                    <input type="text" name="EmpStatus" value="{{ $EmpStatus->EmpStatus }}" class="form-control">
                                    @error('Name')
                            ...
                            <div class="form-row">
                                <div class="col">
                                    ...
                                    <input type="text" name="Notes" value="{{ $EmpStatus->Notes }}" class="form-control">
                                    @error('Name')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
